...
/// <summary>
/// Contains dice sets for all Baffleword game modes.
/// </summary>
public static class DiceSet
{
    ...
    /// <summary>
    /// Gets the standard 16-die set for the 4x4 mode.
    /// </summary>
    ...
    /// <summary>
    /// Gets the Big Board Deluxe set of 25 dice (5x5 grid).
    /// </summary>
    public static IReadOnlyList<Die> BigBoardDice { get; } = new Die[]
    {
        new("A", "A", "A", "F", "R", "S"),
        new("A", "A", "E", "E", "E", "E"),
        new("A", "A", "F", "I", "R", "S"),
    ...
    /// <summary>
    /// Gets the Super Board set of 36 dice (6x6 grid).
    /// Includes two-letter combo faces (QU, IN, TH, ER, HE, AN) and blocked faces.
    /// </summary>
    public static IReadOnlyList<Die> SuperBoardDice { get; } = new Die[]
    {
        new("A", "A", "A", "F", "R", "S"),
        new("A", "A", "E", "E", "E", "E"),
        new("A", "A", "E", "E", "O", "O"),
    ...
    public static IReadOnlyList<Die> GetDiceForMode(GameMode mode)
    {
        return mode switch
        {
            ...
            GameMode.BigBoard => BigBoardDice,
            GameMode.SuperBoard => SuperBoardDice,
